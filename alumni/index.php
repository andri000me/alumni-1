  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <?php if (empty($hasil)): ?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if ($_GET['halaman']=="profil_alumni") {echo "active";} elseif ($_GET['halaman']=="editbiodata") {echo "active";} elseif ($_GET['halaman']=="editortu") {echo "active";} elseif ($_GET['halaman']=="editwali") {echo "active";} elseif ($_GET['halaman']=="editperkembangan") {echo "active";} ?>"><a href="index.php?halaman=profil_alumni"><i class="fa fa-users"></i> <span>Profil Alumni</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        elseif ($_GET['halaman']=="editbiodata")
        {
          include 'pages/profil_alumni/editbiodata.php';
        }
        elseif ($_GET['halaman']=="editalumni")
        {
          include 'pages/profil_alumni/editalumni.php';
        }
        elseif ($_GET['halaman']=="editortu")
        {
          include 'pages/profil_alumni/editortu.php';
        }
        elseif ($_GET['halaman']=="editwali")
        {
          include 'pages/profil_alumni/editwali.php';
        }
        elseif ($_GET['halaman']=="editperkembangan")
        {
          include 'pages/profil_alumni/editperkembangan.php';
        }
