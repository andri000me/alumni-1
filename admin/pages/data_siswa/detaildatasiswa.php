    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item">
          <b>TTL</b> <a class="pull-right"><?php echo $data_alumni['tempat_lahir_siswa'].", ".date('d-M-Y', strtotime($data_alumni['tgl_lahir_siswa'])); ?></a>
          </li>
          <li class="list-group-item">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="nis" class="form-control" value="<?php echo $data_alumni['nis']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Nomor Induk Siswa Nasional (NISN)</label>
                      <input type="text" name="nisn" class="form-control" value="<?php echo $data_alumni['nisn']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Nama Lengkap</label>
                      <input type="text" name="nama_lengkap" class="form-control" value="<?php echo $data_alumni['nama_lengkap']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Nama Panggilan</label>
                      <input type="text" name="nama_panggilan" class="form-control" value="<?php echo $data_alumni['nama_panggilan']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-xs-6">
                          <input type="text" name="tempat_lahir_siswa" class="form-control" placeholder="Tempat Lahir" value="<?php echo $data_alumni['tempat_lahir_siswa']; ?>">
                        </div>
                        <div class="col-xs-6">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control datepicker" name="tgl_lahir_siswa" value="<?php echo $data_alumni['tgl_lahir_siswa']; ?>">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" name="no_hp" class="form-control" value="<?php echo $data_alumni['no_hp']; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-1">
                    <a href="index.php?halaman=data_siswa" class="btn btn-danger" onClick='return confirm("Apakah anda ingin membatalkannya?")' data-dismiss="modal" ><i class="fa fa-ban"></i>&nbsp; Batal</a>
                  </div> -->
                  <!-- button simpan -->
                  <!-- <div class="col-md-6 col-md-offset-5 col-sm-1">
                    <button class="btn btn-success" name="edit"><i class="fa fa-save"></i>&nbsp; Simpan</button>
                  </div> -->
                </form>
              </div>
            </div>
