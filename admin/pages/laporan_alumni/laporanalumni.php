...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title hidden-print">Laporan Data Alumni</h3>
        <h3 class="hidden-xs" style="text-align: center;"><b>LAPORAN DATA ALUMNI SMK NEGERI 1 JOGONALAN KLATEN</b></h3>
    </div>
    <div class="box-body">
        <div class="row">
            <!-- ./ Pilih Laporan -->
            ...
            <div class="col-md-8">
                ...
                <div class="box box-success collapsed-box box-solid hidden-print">
                    <div class="box-header with-border">
                        <center><h3 class="box-title">Registrasi Alumni</h3></center>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                            </button>
                        </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-3">
                                <input type="checkbox" class="alumni" id="kegiatan_lulus"> Kegiatan setelah lulus
                            </div>
                            <div class="col-sm-3">
