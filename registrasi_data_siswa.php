    ...
    <div class="col-md-10 col-sm-6 col-sm-offset-1">
      <div class="box">
        ...
        <div class="box-header with-border">
          <h2 style="text-align: center;">Registrasi Biodata Siswa/Siswi SMK Negeri 1 Jogonalan Klaten</h2>
        </div>
        <div class="box-body">
          <!-- Form Tambah Siswa -->
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <input type="text" name="tempat_lahir_siswa" class="form-control" placeholder="Tempat Lahir" value="<?php ['tempat_lahir_siswa']; ?>" required>
                  </div>
                  <div class="col-xs-6">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datepicker" name="tgl_lahir_siswa" required>
                    </div>
                  </div>
                </div>
              </div>
          ...
          if (isset($_POST['simpan'])) 
          {
            ...
            if ($banyak_karakter_nis == 4) 
            {
              ...
              {
                echo "<script>alert('Nis/Data sudah ada, gagal disimpan. Silahkan daftar dengan kembali');</script>";
                echo "<script>location='registrasi_data_siswa.php';</script>";
              }
            }
            else
            {
              echo "<script>alert('Nomor Induk Siswa (NIS) WAJIB 4 Digit, silahkan ulangi');</script>";
                echo "<script>location='registrasi_data_siswa.php';</script>";
            }
          }
