    ...
    <div class="col-md-6 col-sm-6 col-sm-offset-3">
      <div class="box">
        <div class="callout callout-warning">
          ...
          <p style="text-align: justify; font-size: 20px;">Ketentuan pengisian data perkembangan alumni SMK Negeri 1 Jogonalan Klaten dapat diperhatikan sebagai berikut</p>
          <ul style="font-size: 16px;">
            <li>lengkapi data sesuai dengan data perkembangan anda saat masih sekolah di SMK Negeri 1 Jogonalan Klaten</li>
        ...
        <div class="box-body">
          ...
          <?php 
            if (isset($_POST['simpan'])) 
            {
              ...
              if ($hasil=="berhasil") 
              {
                echo "<script>alert('Selamat, data yang anda daftarkan telah disimpan ^_^');</script>";
                echo "<script>location='login.php';</script>";
              }
              else
              {
                echo "<script>alert('Data gagal disimpan, nis/data tersebut telah ada, silahkan diulangi');</script>";
                echo "<script>location='registrasi_perkembangan_siswa.php';</script>";
              }
            }
          ?>
        </div>
