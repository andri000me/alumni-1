    ...
    <div class="col-md-8 col-sm-6 col-sm-offset-2">
      <div class="box">
        ...
        <div class="box-header with-border">
          <h2 style="text-align: center;">Registrasi Data Orang Tua Siswa/Siswi SMK Negeri 1 Jogonalan Klaten</h2>
        </div>
        <div class="box-body">
          <!-- Form Tambah Siswa -->
          <form method="POST" enctype="">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_ayah_siswa" class="form-control" required>
              </div>
              <div class="form-group">
                <label>Tempat/Tanggal/Lahir Ayah</label>
                <div class="row">
                  <div class="col-xs-6">
                    <input type="text" name="tempat_lahir_ayah" class="form-control" placeholder="Tempat Lahir" required>
                  </div>
                  <div class="col-xs-6">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datepicker" name="tgl_lahir_ayah" required>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="nama_ibu_siswa" class="form-control" required>
              </div>
              <div class="form-group">
                <label>Tempat/Tanggal/Lahir Ibu</label>
                <div class="row">
                  <div class="col-xs-6">
                    <input type="text" name="tempat_lahir_ibu" class="form-control" placeholder="Tempat Lahir" required>
                  </div>
                  <div class="col-xs-6">
                    <div class="input-group">
                      <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control datepicker" name="tgl_lahir_ibu" required>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="penghasilan_perbulan_ibu" class="form-control" required>
                <p class="help-block">Ket : Penghasilan terbaru</p>
              </div>
              <div class="form-group">
          ...
          if (isset($_POST['simpan'])) 
          {
            ...
            {
              echo "<script>alert('Data gagal disimpan, nis/data tersebut telah ada, silahkan diulangi');</script>";
