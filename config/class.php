...
class alumni extends utama
{
    ...
    function merubah_biodata_alumni ($nisn,$nama_lengkap,$nama_panggilan,$jk_siswa,$tempat_lahir_siswa,$tgl_lahir_siswa,/*$umur_siswa,*/$agama_siswa,$kewarganegaraan_siswa,$anakke_siswa,$jmlh_saudara_kndng,$jmlh_saudara_tiri,$jmlh_saudara_angkat,$anak_siswa,$bhsa_sehari,$alamat_siswa,$no_hp,$tinggal_bersama,$jarak_rumah,$golongan_darah,$penyakit_siswa,$kelainan_jasmani,$tinggi_badan,$berat_badan,$lulusan_dari,$tgl_ijazah,$no_ijazah,$tgl_no_stl,$lama_belajar,$pindah_sekolah,$terima_ditingkat,$alasan_pindah,$bidang_study,$kompetensi_keahlian,$tgl_masuk_sekolah,$nis)
    {
        $this->koneksi->query("UPDATE data_siswa SET nisn='$nisn',nama_lengkap='$nama_lengkap',nama_panggilan='$nama_panggilan',jk_siswa='$jk_siswa',tempat_lahir_siswa='$tempat_lahir_siswa',tgl_lahir_siswa='$tgl_lahir_siswa',/*umur_siswa='$umur_siswa',*/agama_siswa='$agama_siswa',kewarganegaraan_siswa='$kewarganegaraan_siswa',anakke_siswa='$anakke_siswa',jmlh_saudara_kndng='$jmlh_saudara_kndng',jmlh_saudara_tiri='$jmlh_saudara_tiri',jmlh_saudara_angkat='$jmlh_saudara_angkat',anak_siswa='$anak_siswa',bhsa_sehari='$bhsa_sehari',alamat_siswa='$alamat_siswa',no_hp='$no_hp',tinggal_bersama='$tinggal_bersama',jarak_rumah='$jarak_rumah',golongan_darah='$golongan_darah',penyakit_siswa='$penyakit_siswa',kelainan_jasmani='$kelainan_jasmani',tinggi_badan='$tinggi_badan',berat_badan='$berat_badan',lulusan_dari='$lulusan_dari',tgl_ijazah='$tgl_ijazah',no_ijazah='$no_ijazah',tgl_no_stl='$tgl_no_stl',lama_belajar='$lama_belajar',pindah_sekolah='$pindah_sekolah',terima_ditingkat='$terima_ditingkat',alasan_pindah='$alasan_pindah',bidang_study='$bidang_study',kompetensi_keahlian='$kompetensi_keahlian',tgl_masuk_sekolah='$tgl_masuk_sekolah' WHERE nis='$nis' ") or die(mysqli_error($this->koneksi));
        return "sukses";
    }
